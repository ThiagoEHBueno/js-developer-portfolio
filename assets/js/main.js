...
function updateExperience(profileData) {
    const experience = document.getElementById('personal.experience')
    experience.innerHTML = profileData.professionalExperience.map(professional => {
        return `
            <li>
              <h3 class="title ">${professional.name}</h3>
